...
//            break;
//        }} while (option!=5); }
//       catch (InputMismatchException e){System.out.println("please Enter number only");}
...
//        random( min, max, randomNumber); }catch (InputMismatchException e){
//            System.out.println("please enter numbers only");
//        }
        ...
        }catch (InputMismatchException e){System.out.println("please enter only numbers ");}
    }
...
//4
     ...
     */
//5
//public static void takeValue(int []a,int r) throws InputMismatchException{
//    Scanner s = new Scanner(System.in);
//    for(int i=0;i<r;i++) {
